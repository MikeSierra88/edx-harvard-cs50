...
gTextures = {
    ...
    ['lock-key'] = love.graphics.newImage('graphics/keys_and_locks.png'),
...
gFrames = {
    ...
    ['lock-key'] = GenerateQuads(gTextures['lock-key'], 16, 16),
    ['flagpoles'] = GenerateFlagpoleQuads(gTextures['flagpoles']),
