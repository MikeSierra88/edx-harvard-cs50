...
function GenerateQuadsBricks(atlas)
    ...
    table.insert(bricks, love.graphics.newQuad(160, 48, 32, 16,
        atlas:getDimensions()))
    return bricks
end
...
function GenerateQuadsPowerups(atlas)
    ...
    local y = 192
    local quads = {}
    print(atlas:getDimensions())
    quads['extraballs'] = love.graphics.newQuad(x, y, 16, 16, atlas:getDimensions())
    quads['key'] = love.graphics.newQuad(x + 16, y, 16, 16, atlas:getDimensions())
